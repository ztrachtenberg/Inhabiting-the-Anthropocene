...
var BlogEles = {
    nodes: [
    // Filter Nodes
        { data: { id: 'B', label: 'Filter Edges By', name: 'Filter Edges By', href: '', color: '#808080', weight: 300, faveShape: 'roundrectangle', filter: 'yes' }, position: { x: 800, y: 250}, locked: true, selectable: false },
        { data: { id: 'Similar', label: 'Similar', name: 'Similar', href: '', color: 'green', weight: 45, faveShape: 'roundrectangle', parent: 'B', filter: 'yes' }, position: { x: 800, y: 200 }, locked: true },
        { data: { id: 'Different', label: 'Different', name: 'Different', href: '', color: 'green', weight: 45, faveShape: 'roundrectangle', parent: 'B', filter: 'yes' }, position: { x: 800, y: 250 }, locked: true },
