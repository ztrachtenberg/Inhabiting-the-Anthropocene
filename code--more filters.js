...
cy.on('tap', 'node', function () {
	//FOR APPROACH VIEW
    if (!this.hasClass('triggered') && this.data('name') == 'Descriptive'){
        this.removeClass('untriggered');
        this.addClass('triggered');
        cy.filter(function(i, element){
            if (element.isEdge() && (element.data("comment") == 'Descriptive')){
                element.addClass('invisible');
            }
        })
    } else if (this.hasClass('triggered') && this.data('name') == 'Descriptive'){   
    ...
    } else if (!this.hasClass('triggered') && this.data('name') == 'Interpretive'){
        this.removeClass('untriggered');
        this.addClass('triggered');
        cy.filter(function(i, element){
            if (element.isEdge() && (element.data("comment") == 'Interpretive')){
                element.addClass('invisible');
            }
        })
    } else if (this.hasClass('triggered') && this.data('name') == 'Interpretive'){   
    ...
    } else if (!this.hasClass('triggered') && this.data('name') == 'Normative'){
        this.removeClass('untriggered');
        this.addClass('triggered');
        cy.filter(function(i, element){
            if (element.isEdge() && (element.data("comment") == 'Normative')){
                element.addClass('invisible');
            }
        })
    } else if (this.hasClass('triggered') && this.data('name') == 'Normative'){   
        ...
        })    } else if (!this.hasClass('triggered') && this.data('name') == 'Practical'){
        this.removeClass('untriggered');
        this.addClass('triggered');
        cy.filter(function(i, element){
            if (element.isEdge() && (element.data("comment") == 'Practical')){
                element.addClass('invisible');
            }
        })
    } else if (this.hasClass('triggered') && this.data('name') == 'Practical'){   
    ...
    //FOR THEMES VIEW
	} else if (!this.hasClass('triggered') && this.data('name') == 'History'){
        this.removeClass('untriggered');
        this.addClass('triggered');
        cy.filter(function(i, element){
            if (element.isEdge() && (element.data("comment") == 'History')){
                element.addClass('invisible');
            }
        })
    } else if (this.hasClass('triggered') && this.data('name') == 'History'){   
    ...
    } else if (!this.hasClass('triggered') && this.data('name') == 'Future'){
        this.removeClass('untriggered');
        this.addClass('triggered');
        cy.filter(function(i, element){
            if (element.isEdge() && (element.data("comment") == 'Future')){
                element.addClass('invisible');
            }
        })
    } else if (this.hasClass('triggered') && this.data('name') == 'Future'){   
    ...
    } else if (!this.hasClass('triggered') && this.data('name') == 'Agency'){
        this.removeClass('untriggered');
        this.addClass('triggered');
        cy.filter(function(i, element){
            if (element.isEdge() && (element.data("comment") == 'Agency')){
                element.addClass('invisible');
            }
        })
    } else if (this.hasClass('triggered') && this.data('name') == 'Agency'){   
        ...
        })    } else if (!this.hasClass('triggered') && this.data('name') == 'Limits'){
        this.removeClass('untriggered');
        this.addClass('triggered');
        cy.filter(function(i, element){
            if (element.isEdge() && (element.data("comment") == 'Limits')){
                element.addClass('invisible');
            }
        })
    } else if (this.hasClass('triggered') && this.data('name') == 'Limits'){   
	...
	//FOR AUTHOR-SUPPLIED PAIRINGS VIEW
	} else if (!this.hasClass('triggered') && this.data('name') == 'Similar'){
        this.removeClass('untriggered');
        this.addClass('triggered');
        cy.filter(function(i, element){
            if (element.isEdge() && (element.data("comment2") == 'Similar')){
                element.addClass('invisible');
            }
        })
    } else if (this.hasClass('triggered') && this.data('name') == 'Similar'){   
        ...
        this.addClass('triggered');
        cy.filter(function(i, element){
            if (element.isEdge() && (element.data("comment2") == 'Different')){
                element.addClass('invisible');
            }
        })
    } else if (this.hasClass('triggered') && this.data('name') == 'Different'){   
        ...
        this.addClass('triggered');
        cy.filter(function(i, element){
            if (element.isEdge() && (element.data("comment2") == 'Same author')){
                element.addClass('invisible');
            }
        })
    } else if (this.hasClass('triggered') && this.data('name') == 'Same author'){   
