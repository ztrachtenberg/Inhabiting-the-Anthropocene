...
//Post nodes
   ...
   edges: [
	//From AR1
	 ...
	 //FROM AC2
	 { data: { source: 'AC2', target: 'AR2', AuthColor: '#737373', width: 3, Arrow: 'none', style: 'solid'} },
     { data: { source: 'AC2', target: 'MW2', AuthColor: '#737373', width: 3, Arrow: 'none', style: 'solid'} },
	 //FROM AR1
	 { data: { source: 'AR1', target: 'AR2', AuthColor: '#737373', width: 3, Arrow: 'none', style: 'solid'} },
     { data: { source: 'AR1', target: 'MW1', AuthColor: '#737373', width: 3, Arrow: 'none', style: 'solid'} },
     { data: { source: 'AR1', target: 'MW2', AuthColor: '#737373', width: 3, Arrow: 'none', style: 'solid'} },
     { data: { source: 'AR1', target: 'NT2', AuthColor: '#737373', width: 3, Arrow: 'none', style: 'solid'} },
     { data: { source: 'AR1', target: 'ZT2', AuthColor: '#737373', width: 3, Arrow: 'none', style: 'solid'} },
	 //FROM AR2
	 { data: { source: 'AR2', target: 'MW1', AuthColor: '#737373', width: 3, Arrow: 'none', style: 'solid'} },
     { data: { source: 'AR2', target: 'MW2', AuthColor: '#737373', width: 3, Arrow: 'none', style: 'solid'} },
     { data: { source: 'AR2', target: 'MW2', AuthColor: '#737373', width: 3, Arrow: 'none', style: 'solid'} },
     { data: { source: 'AR2', target: 'NT2', AuthColor: '#737373', width: 3, Arrow: 'none', style: 'solid'} },
     { data: { source: 'AR2', target: 'ZT2', AuthColor: '#737373', width: 3, Arrow: 'none', style: 'solid'} },
	 //FROM IS1
	 { data: { source: 'IS1', target: 'IS2', AuthColor: '#737373', width: 3, Arrow: 'none', style: 'solid'} },
     { data: { source: 'IS1', target: 'IS2', AuthColor: '#737373', width: 3, Arrow: 'none', style: 'solid'} },
     ...
     { data: { source: 'IS1', target: 'MW1', AuthColor: '#737373', width: 3, Arrow: 'none', style: 'solid'} },
	 { data: { source: 'IS1', target: 'LS1', AuthColor: '#737373', width: 3, Arrow: 'none', style: 'solid'} },
     { data: { source: 'IS1', target: 'LS2', AuthColor: '#737373', width: 3, Arrow: 'none', style: 'solid'} },
     { data: { source: 'IS1', target: 'ZT1', AuthColor: '#737373', width: 3, Arrow: 'none', style: 'solid'} },
     ...
     { data: { source: 'IS2', target: 'MW1', AuthColor: '#737373', width: 3, Arrow: 'none', style: 'solid'} },
	 { data: { source: 'IS2', target: 'LS1', AuthColor: '#737373', width: 3, Arrow: 'none', style: 'solid'} },
     { data: { source: 'IS2', target: 'LS2', AuthColor: '#737373', width: 3, Arrow: 'none', style: 'solid'} },
     { data: { source: 'IS2', target: 'ZT1', AuthColor: '#737373', width: 3, Arrow: 'none', style: 'solid'} },
     ...
     { data: { source: 'KG1', target: 'ZT1', AuthColor: '#737373', width: 3, Arrow: 'none', style: 'solid'} },
     { data: { source: 'KG1', target: 'ZT2', AuthColor: '#737373', width: 3, Arrow: 'none', style: 'solid'} },
	 //FROM KG2
     { data: { source: 'KG2', target: 'LS2', AuthColor: '#737373', width: 3, Arrow: 'none', style: 'solid'} },
     { data: { source: 'KG2', target: 'LS2', AuthColor: '#737373', width: 3, Arrow: 'none', style: 'solid'} },
     { data: { source: 'KG2', target: 'ZT1', AuthColor: '#737373', width: 3, Arrow: 'none', style: 'solid'} },
     { data: { source: 'KG2', target: 'ZT2', AuthColor: '#737373', width: 3, Arrow: 'none', style: 'solid'} },
	 //FROM MW1
     { data: { source: 'MW1', target: 'MW2', AuthColor: '#737373', width: 3, Arrow: 'none', style: 'solid'} },
     { data: { source: 'MW1', target: 'LS1', AuthColor: '#737373', width: 3, Arrow: 'none', style: 'solid'} },
     { data: { source: 'MW1', target: 'NT2', AuthColor: '#737373', width: 3, Arrow: 'none', style: 'solid'} },
     { data: { source: 'MW1', target: 'ZT2', AuthColor: '#737373', width: 3, Arrow: 'none', style: 'solid'} },
	 //FROM MW2
     { data: { source: 'MW2', target: 'NT2', AuthColor: '#737373', width: 3, Arrow: 'none', style: 'solid'} },
     { data: { source: 'MW2', target: 'ZT2', AuthColor: '#737373', width: 3, Arrow: 'none', style: 'solid'} },
	 //FROM LS2
     { data: { source: 'LS2', target: 'ZT1', AuthColor: '#737373', width: 3, Arrow: 'none', style: 'solid'} },
