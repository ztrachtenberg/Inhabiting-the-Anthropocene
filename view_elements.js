...
//POSSIBLE TO MAKE SOME EDGES HEAVIER?
...
//		{ data: { id: 'L', name: 'Limits', color: '#FF99CC', weight:40 } },
	//View nodes
		...
		{ data: { id: 'Ax', name: 'Humans exceptional', color: '#006B6B', weight:120 } },
		{ data: { id: 'Lp', name: 'Physical', color: '#B26B8F', weight:120 } },
	    { data: { id: 'Hr', name: 'Reduction', color: '#AD33FF', weight:120 } },
		{ data: { id: 'Fd', name: 'Danger', color: '#AD855C', weight:120 } },
		{ data: { id: 'An', name: 'Humans entangled', color: '#4DB8B8', weight:120 } },
		{ data: { id: 'Lm', name: 'Moral', color: '#FFB8DB', weight:120 } }
	],	
    edges: [
    //Theme-view edges
//    	{ data: { source: 'H', target: 'Hc', AuthColor: 'red', Arrow: 'none' } },
//      { data: { source: 'H', target: 'Hr', AuthColor: 'red', Arrow: 'none' } },
//        { data: { source: 'F', target: 'Fh', AuthColor: 'red', Arrow: 'none' } },
//        { data: { source: 'F', target: 'Fd', AuthColor: 'red', Arrow: 'none' } },
//        { data: { source: 'A', target: 'Ax', AuthColor: 'red', Arrow: 'none' } },
//        { data: { source: 'A', target: 'An', AuthColor: 'red', Arrow: 'none' } },
//        { data: { source: 'L', target: 'Lp', AuthColor: 'red', Arrow: 'none' } },
//        { data: { source: 'L', target: 'Lm', AuthColor: 'red', Arrow: 'none' } },
	//View-view edges
        { data: { source: 'Hc', target: 'Hr', AuthColor: 'purple', Arrow: 'none' } },
        { data: { source: 'Fh', target: 'Fd', AuthColor: 'red', Arrow: 'none' } },
        { data: { source: 'Ax', target: 'An', AuthColor: 'green', Arrow: 'none' } },
        { data: { source: 'Lp', target: 'Lm', AuthColor: 'pink', Arrow: 'none' } },
		
    //Post-view edges
    //Theme 1
        { data: { source: '1', target: 'Ax', AuthColor: 'red', Arrow: 'none' } },
        { data: { source: '4', target: 'Ax', AuthColor: 'red', Arrow: 'none' } },
        { data: { source: '13', target: 'Hc', AuthColor: 'red', Arrow: 'none' } },
        { data: { source: '14', target: 'Lm', AuthColor: 'red', Arrow: 'none' } },
        { data: { source: '17', target: 'An', AuthColor: 'red', Arrow: 'none' } },
        { data: { source: '18', target: 'Hr', AuthColor: 'red', Arrow: 'none' } },
        { data: { source: '22', target: 'Ax', AuthColor: 'red', Arrow: 'none' } },
        { data: { source: '23', target: 'Lp', AuthColor: 'red', Arrow: 'none' } },
        { data: { source: '25', target: 'Lm', AuthColor: 'red', Arrow: 'none' } },
        { data: { source: '26', target: 'Ax', AuthColor: 'red', Arrow: 'none' } },
        { data: { source: '27', target: 'Lm', AuthColor: 'red', Arrow: 'none' } },
        { data: { source: '28', target: 'Ax', AuthColor: 'red', Arrow: 'none' } },
        { data: { source: '29', target: 'Hc', AuthColor: 'red', Arrow: 'none' } },
        { data: { source: '31', target: 'Fh', AuthColor: 'red', Arrow: 'none' } },
        { data: { source: '32', target: 'An', AuthColor: 'red', Arrow: 'none' } },
        { data: { source: '36', target: 'Fd', AuthColor: 'red', Arrow: 'none' } },
    //Theme 2
        { data: { source: '4', target: 'Hr', AuthColor: 'red', Arrow: 'none' } },
        { data: { source: '14', target: 'Hr', AuthColor: 'red', Arrow: 'none' } },
        { data: { source: '17', target: 'Hc', AuthColor: 'red', Arrow: 'none' } },
        { data: { source: '22', target: 'Hr', AuthColor: 'red', Arrow: 'none' } },
        { data: { source: '23', target: 'Fd', AuthColor: 'red', Arrow: 'none' } },
        { data: { source: '25', target: 'Ax', AuthColor: 'red', Arrow: 'none' } },
        { data: { source: '26', target: 'Fd', AuthColor: 'red', Arrow: 'none' } },
        { data: { source: '27', target: 'Fh', AuthColor: 'red', Arrow: 'none' } },
        { data: { source: '28', target: 'Hr', AuthColor: 'red', Arrow: 'none' } },
        { data: { source: '29', target: 'Fh', AuthColor: 'red', Arrow: 'none' } },
        { data: { source: '31', target: 'Lp', AuthColor: 'red', Arrow: 'none' } },
        { data: { source: '32', target: 'Lm', AuthColor: 'red', Arrow: 'none' } },
        { data: { source: '36', target: 'Ax', AuthColor: 'red', Arrow: 'none' } }
    ]
}