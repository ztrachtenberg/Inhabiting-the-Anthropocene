...
//Theme nodes
//	    { data: { id: 'H', label: 'H', preview: 'text/legends/bios/H-bio.html', name: 'History', href: 'text/main/themes/themes-H.html', color: '#737373', weight:60, faveShape: 'triangle'  } },
//		{ data: { id: 'F', label: 'F', preview: 'text/legends/bios/F-bio.html', name: 'Future', href: 'text/main/themes/themes-F.html', color: '#737373', weight:60, faveShape: 'rectangle'  } },
//		{ data: { id: 'A', label: 'A', preview: 'text/legends/bios/A-bio.html', name: 'Agency', href: 'text/main/themes/themes-A.html', color: '#737373', weight:60, faveShape: 'pentagon'  } },
//		{ data: { id: 'L', label: 'L', preview: 'text/legends/bios/L-bio.html', name: 'Limits', href: 'text/main/themes/themes-L.html', color: '#737373', weight:60, faveShape: 'hexagon'  } },

//Post nodes
        /*{ data: { id: 'ZT1', label: '', preview: 'text/legends/bios/ZT.html', name: 'Of Property', href: 'text/posts/ZT1.html', color: '#5AA7C3', weight: 55, faveShape: 'ellipse' } },
        { data: { id: 'KG1', label: '', preview: 'text/legends/bios/KG.html', name: 'Organisms as Ecosystem Engineers', href: 'text/posts/KG1.html', color: '#5AA7C3', weight: 55, faveShape: 'ellipse' } },
        { data: { id: 'AR1', label: '', preview: 'text/legends/bios/AR.html', name: '"Diachronous Beginnings of the Anthropocene: The Lower Bounding Surface of Anthropogenic Deposits"', href: 'text/posts/AR1.html', color: '#5AA7C3', weight: 55, faveShape: 'ellipse' } },
        { data: { id: 'MW1', label: '', preview: 'text/legends/bios/MW.html', name: 'Building "Equitable" Urban Resilience: The Challenge for Cities', href: 'text/posts/MW1.html', color: '#5AA7C3', weight: 55, faveShape: 'ellipse' } },
        { data: { id: 'NT1', label: '', preview: 'text/legends/bios/NT.html', name: 'Principles of Tsawalk: An Indigenous Approach to Global Crisis', href: 'text/posts/NT1.html', color: '#5AA7C3', weight: 55, faveShape: 'ellipse' } },
        { data: { id: 'LS1', label: '', preview: 'text/legends/bios/LS.html', name: '"Loess: The Yellow Earth"', href: 'text/posts/LS1.html', color: '#5AA7C3', weight: 55, faveShape: 'ellipse' } },
        { data: { id: 'IS1', label: '', preview: 'text/legends/bios/IS.html', name: '"Concluding Remarks" on Animal Ecology and Demography', href: 'text/posts/IS1.html', color: '#5AA7C3', weight: 55, faveShape: 'ellipse' } },
        { data: { id: 'AC1', label: '', preview: 'text/legends/bios/AC.html', name: '"A Safe Operating Space for Humanity"', href: 'text/posts/AC1.html', color: '#5AA7C3', weight: 55, faveShape: 'ellipse' } },
        { data: { id: 'ZT2', label: '', preview: 'text/legends/bios/ZT.html', name: 'Toward an Ethics of Niche Construction', href: 'text/posts/ZT2.html', color: '#5AA7C3', weight: 55, faveShape: 'ellipse' } },
        { data: { id: 'KG2', label: '', preview: 'text/legends/bios/KG.html', name: 'Implications of Manufacturing Habitability', href: 'text/posts/KG2.html', color: '#5AA7C3', weight: 55, faveShape: 'ellipse' } },
        { data: { id: 'MW2', label: '', preview: 'text/legends/bios/MW.html', name: 'Advancing Equity and Going Beyond Basic Survival', href: 'text/posts/MW2.html', color: '#5AA7C3', weight: 55, faveShape: 'ellipse' } },
        { data: { id: 'IS2', label: '', preview: 'text/legends/bios/IS.html', name: 'Memes as a Dimension of the Human Niche', href: 'text/posts/IS2.html', color: '#5AA7C3', weight: 55, faveShape: 'ellipse' } },
        { data: { id: 'AR2', label: '', preview: 'text/legends/bios/AR.html', name: "Habitability's Non-Inevitability", href: 'text/posts/AR2.html', color: '#5AA7C3', weight: 55, faveShape: 'ellipse' } },
        { data: { id: 'AC2', label: '', preview: 'text/legends/bios/AC.html', name: 'Habitability as a commons: Fearing a tragedy of human(ized) nature', href: 'text/posts/AC2.html', color: '#5AA7C3', weight: 55, faveShape: 'ellipse' } },
        { data: { id: 'NT2', label: '', preview: 'text/legends/bios/NT.html', name: 'Toward a More Than Human Anthropocene', href: 'text/posts/NT2.html', color: '#5AA7C3', weight: 55, faveShape: 'ellipse' } },
        { data: { id: 'LS2', label: '', preview: 'text/legends/bios/LS.html', name: 'The Dust of Civilization', href: 'text/posts/LS2.html', color: '#5AA7C3', weight: 55, faveShape: 'ellipse' } },*/

        /*{ data: { id: 'ZT1', label: '', preview: 'text/legends/bios/ZT.html', name: 'Of Property', href: 'text/posts/ZT1.html', color: '#8DC162', weight: 55, faveShape: 'ellipse' } },
        { data: { id: 'KG1', label: '', preview: 'text/legends/bios/KG.html', name: 'Organisms as Ecosystem Engineers', href: 'text/posts/KG1.html', color: '#FFEAAC', weight: 55, faveShape: 'ellipse' } },
        { data: { id: 'AR1', label: '', preview: 'text/legends/bios/AR.html', name: '"Diachronous Beginnings of the Anthropocene: The Lower Bounding Surface of Anthropogenic Deposits"', href: 'text/posts/AR1.html', color: '#C2627F', weight: 55, faveShape: 'ellipse' } },
        { data: { id: 'MW1', label: '', preview: 'text/legends/bios/MW.html', name: 'Building "Equitable" Urban Resilience: The Challenge for Cities', href: 'text/posts/MW1.html', color: '#585898', weight: 55, faveShape: 'ellipse' } },
        { data: { id: 'NT1', label: '', preview: 'text/legends/bios/NT.html', name: 'Principles of Tsawalk: An Indigenous Approach to Global Crisis', href: 'text/posts/NT1.html', color: '#791634', weight: 55, faveShape: 'ellipse' } },
        { data: { id: 'LS1', label: '', preview: 'text/legends/bios/LS.html', name: '"Loess: The Yellow Earth"', href: 'text/posts/LS1.html', color: '#5C4501', weight: 55, faveShape: 'ellipse' } },
        { data: { id: 'IS1', label: '', preview: 'text/legends/bios/IS.html', name: '"Concluding Remarks" on Animal Ecology and Demography', href: 'text/posts/IS1.html', color: '#876B19', weight: 55, faveShape: 'ellipse' } },
        { data: { id: 'AC1', label: '', preview: 'text/legends/bios/AC.html', name: '"A Safe Operating Space for Humanity"', href: 'text/posts/AC1.html', color: '#D9BE6E', weight: 55, faveShape: 'ellipse' } },
        { data: { id: 'ZT2', label: '', preview: 'text/legends/bios/ZT.html', name: 'Toward an Ethics of Niche Construction', href: 'text/posts/ZT2.html', color: '#8DC162', weight: 55, faveShape: 'ellipse' } },
        { data: { id: 'KG2', label: '', preview: 'text/legends/bios/KG.html', name: 'Implications of Manufacturing Habitability', href: 'text/posts/KG2.html', color: '#FFEAAC', weight: 55, faveShape: 'ellipse' } },
        { data: { id: 'MW2', label: '', preview: 'text/legends/bios/MW.html', name: 'Advancing Equity and Going Beyond Basic Survival', href: 'text/posts/MW2.html', color: '#585898', weight: 55, faveShape: 'ellipse' } },
        { data: { id: 'IS2', label: '', preview: 'text/legends/bios/IS.html', name: 'Memes as a Dimension of the Human Niche', href: 'text/posts/IS2.html', color: '#876B19', weight: 55, faveShape: 'ellipse' } },
        { data: { id: 'AR2', label: '', preview: 'text/legends/bios/AR.html', name: "Habitability's Non-Inevitability", href: 'text/posts/AR2.html', color: '#C2627F', weight: 55, faveShape: 'ellipse' } },
        { data: { id: 'AC2', label: '', preview: 'text/legends/bios/AC.html', name: 'Habitability as a commons: Fearing a tragedy of human(ized) nature', href: 'text/posts/AC2.html', color: '#D9BE6E', weight: 55, faveShape: 'ellipse' } },
        { data: { id: 'NT2', label: '', preview: 'text/legends/bios/NT.html', name: 'Toward a More Than Human Anthropocene', href: 'text/posts/NT2.html', color: '#791634', weight: 55, faveShape: 'ellipse' } },
        { data: { id: 'LS2', label: '', preview: 'text/legends/bios/LS.html', name: 'The Dust of Civilization', href: 'text/posts/LS2.html', color: '#5C4501', weight: 55, faveShape: 'ellipse' } },*/
