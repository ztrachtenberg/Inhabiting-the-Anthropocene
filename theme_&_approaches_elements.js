...
var BlogEles = {
    ...
    //Primary approach edges
        ...
        { data: { source: '13', target: 'I', AuthColor: 'blue', Arrow: 'none' } },
        { data: { source: '14', target: 'P', AuthColor: 'green', Arrow: 'none' } },
        { data: { source: '17', target: 'I', AuthColor: 'blue', Arrow: 'none' } },
        { data: { source: '18', target: 'D', AuthColor: 'yellow', Arrow: 'none' } },
        { data: { source: '22', target: 'D', AuthColor: 'yellow', Arrow: 'none' } },
        { data: { source: '23', target: 'D', AuthColor: 'yellow', Arrow: 'none' } },
        { data: { source: '25', target: 'N', AuthColor: 'red', Arrow: 'none' } },
        { data: { source: '26', target: 'D', AuthColor: 'yellow', Arrow: 'none' } },
        { data: { source: '27', target: 'P', AuthColor: 'green', Arrow: 'none' } },
        { data: { source: '28', target: 'D', AuthColor: 'yellow', Arrow: 'none' } },
        { data: { source: '29', target: 'I', AuthColor: 'blue', Arrow: 'none' } },
        { data: { source: '31', target: 'D', AuthColor: 'yellow', Arrow: 'none' } },
        { data: { source: '32', target: 'I', AuthColor: 'blue', Arrow: 'none' } },
        { data: { source: '36', target: 'D', AuthColor: 'yellow', Arrow: 'none' } },
    //Secondary approach edges
        { data: { source: '13', target: 'D', AuthColor: 'black', Arrow: 'none' } },
        { data: { source: '14', target: 'N', AuthColor: 'black', Arrow: 'none' } },
        { data: { source: '17', target: 'N', AuthColor: 'black', Arrow: 'none' } },
        { data: { source: '18', target: 'I', AuthColor: 'black', Arrow: 'none' } },
        { data: { source: '22', target: 'I', AuthColor: 'black', Arrow: 'none' } },
        { data: { source: '23', target: 'N', AuthColor: 'black', Arrow: 'none' } },
        { data: { source: '25', target: 'D', AuthColor: 'black', Arrow: 'none' } },
        { data: { source: '26', target: 'P', AuthColor: 'black', Arrow: 'none' } },
        { data: { source: '27', target: 'N', AuthColor: 'black', Arrow: 'none' } },
        { data: { source: '28', target: 'I', AuthColor: 'black', Arrow: 'none' } },
        { data: { source: '29', target: 'D', AuthColor: 'black', Arrow: 'none' } },
